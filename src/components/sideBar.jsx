  ...
  return (
    ...
    >
      <Flex
        ...
        align="center"
        style={{ marginTop: -0, width: 250, height: 68 }}
      >
        <Space size={[50]} style={{ marginLeft: 20 }}>
          ...
          <Button
            ...
            icon={
              <RiExpandLeftLine
                style={{ width: 20, height: 20, color: "rgba(0,0,0,0.25)" }}
              />
            }
      ...
      >
        ...
        <Menu.Item key="unit-business" icon={<RiBriefcaseLine size={20} />}>
        ...
        <Menu.Item key="category-product" icon={<RiFolder2Line size={20} />}>
          <Link to="/category-product" style={{ textAlign: "left" }}>
            Kategori Produk
          </Link>
        </Menu.Item>
        <Menu.Item
        ...
        >
          <Link to="/product" style={{ textAlign: "left" }}>
            Produk
          </Link>
        </Menu.Item>
        {/* <p
